...
Dr. Tang has led the [AI City Challenge](https://www.aicitychallenge.org/) organizing committee at CVPR, ICCV, and ECCV since 2020, helping grow the decade-long challenge to 2.5K participating teams across 48 countries and regions, with the 2026 ECCV results covered by [NVIDIA AI on X](https://x.com/NVIDIAAI/status/2097409504728269183). Through this initiative, he helped release the [PhysicalAI-SmartSpaces (PAISS)](https://huggingface.co/datasets/nvidia/PhysicalAI-SmartSpaces) dataset for multi-camera 3D perception, which has received over 700,000 downloads. He is also a Senior Area Editor for [*IEEE Transactions on Circuits and Systems for Video Technology* (T-CSVT)](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=76), and an Area Chair for ACM Multimedia.
