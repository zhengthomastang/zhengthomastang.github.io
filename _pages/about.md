...
Dr. Tang’s research spans multimodal AI, including VLM/LLM evaluation, embedding-based retrieval, active and reinforcement learning, 2D/3D/BEV perception, synthetic data generation, and intelligent transportation. He holds 17 filed U.S. patents and has published 28 peer-reviewed papers in leading journals and conferences. At NVIDIA, he developed multimodal fusion search for the [NVIDIA VSS Blueprint](https://docs.nvidia.com/vss/latest/index.html), featured in a GTC’26 live demonstration, and created VANTAGE-Bench and TAR for physical AI VLM/LLM evaluation, highlighted in the Cosmos 3 release at Computex’26. He also developed DEFT, an active-learning pipeline for data-efficient fine-tuning, and proposed a reinforcement-learning framework for hard-query retrieval and ranking.

Dr. Tang has led the [AI City Challenge](https://www.aicitychallenge.org/) organizing committee at CVPR, ICCV, and ECCV since 2020, helping grow the decade-long challenge to 2.5K participating teams across 48 countries and regions, with the 2026 ECCV results covered by [NVIDIA AI](https://x.com/NVIDIAAI/status/2097409504728269183) and [ECCV Daily News](https://www.rsipvision.com/ECCV2026-Thursday/12/). Through this initiative, he helped release the [PhysicalAI-SmartSpaces (PAISS)](https://huggingface.co/datasets/nvidia/PhysicalAI-SmartSpaces) dataset for multi-camera 3D perception, which has received over 800,000 downloads, and the corresponding benchmark paper was accepted to NeurIPS 2026. He is also a Senior Area Editor for [*IEEE Transactions on Circuits and Systems for Video Technology* (T-CSVT)](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=76), and an Area Chair for ACM Multimedia.

Dr. Tang delivered an invited keynote at the [UrbanAI Workshop](https://urbanai2025.github.io/) at NeurIPS 2025 and received Best Presentation and Best Poster awards at NTECH 2024 (NVIDIA's internal annual technical conference). He received the T-CSVT Best Associate Editor Award in 2021, led winning teams in two tracks of the [2018 AI City Challenge](https://www.aicitychallenge.org/2018-ai-city-challenge/) at CVPR, and was a finalist for the Best Scientific Paper and Best Student Paper awards at [ICPR 2016](https://iapr.org/archives/icpr2016/site.1.html).

## <i class="fa fa-fw fa-rss "></i> News ##

<ul style="width: auto; height: 300px; overflow: auto">

  <li><b>[Sep. 2026]</b> Two papers on <a href="/posts/2026/09/blog-post-2/">Traffic Anomaly Reasoning (TAR) and Physical AI Smart Spaces (PAISS)</a> were accepted to the NeurIPS 2026 Evaluations and Datasets Track; the PAISS dataset has also received over 800,000 downloads</li>

  <li><b>[Sep. 2026]</b> Successfully concluded the <a href="/posts/2026/09/blog-post-1/">10th AI City Challenge at ECCV 2026</a>, with 2.5K teams across 48 countries and regions engaged over the decade-long challenge, the 2026 results featured by <a href="https://x.com/NVIDIAAI/status/2097409504728269183">NVIDIA AI</a>, <a href="https://www.rsipvision.com/ECCV2026-Thursday/12/">ECCV Daily News</a>, and an <a href="https://www.linkedin.com/feed/update/urn:li:activity:7501277492108775424/">iMerit interview</a></li>
