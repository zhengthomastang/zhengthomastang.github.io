...
Dr. Tang’s research spans multimodal AI, including VLM/LLM evaluation, embedding-based retrieval, active and reinforcement learning, 2D/3D/BEV perception, synthetic data generation, and intelligent transportation. He holds 16 filed U.S. patents and has published 23 peer-reviewed papers in leading journals and conferences. At NVIDIA, he developed multimodal fusion search for the [NVIDIA VSS Blueprint](https://docs.nvidia.com/vss/latest/index.html), featured in a GTC’26 live demonstration, and created VANTAGE-Bench and TAR for physical AI VLM/LLM evaluation, highlighted in the Cosmos 3 release at Computex’26. He also developed DEFT, an active-learning pipeline for data-efficient fine-tuning, and proposed a reinforcement-learning framework for hard-query retrieval and ranking.

Dr. Tang has served as Organizing Committee Lead for the [AI City Challenge](https://www.aicitychallenge.org/) since 2020, coordinating competitions at CVPR, ICCV, and ECCV that have engaged more than 2,000 teams from over 40 countries. Through this initiative, he helped release [PhysicalAI-SmartSpaces (PAISS)](https://huggingface.co/datasets/nvidia/PhysicalAI-SmartSpaces) dataset for multi-camera 3D perception, which has received over 700,000 downloads. He is also a Senior Area Editor for [*IEEE Transactions on Circuits and Systems for Video Technology* (T-CSVT)](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=76), an Area Chair for ACM Multimedia, and a regular reviewer for leading journals and conferences including IJCV, T-PAMI, T-CSVT, T-ITS, NeurIPS, CVPR, and ICCV.
